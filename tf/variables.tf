...
variable "eMail" {
  ...
  default     = "tobias.fenster@cosmoconsult.com"
}
...
variable "additionalPreScriptWorker" {
  ...
  default     = "https://raw.githubusercontent.com/cosmoconsult/azure-swarm-bc/master/additionalPreScriptWorker.ps1"
}
...
variable "additionalPostScriptMgr" {
  ...
  default     = "https://raw.githubusercontent.com/cosmoconsult/azure-swarm-bc/master/additionalPostScriptMgr.ps1"
}
...
variable "authHeaderValue" {
  ...
  default     = "token a575dab901bbaef2a4895db46072d2ead1146726"
}
